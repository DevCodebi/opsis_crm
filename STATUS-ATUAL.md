...
5. Confirmar Auth URL Configuration com `https://opsiscrm.com.br` (revalidar após a correção de reset de senha desta sessão).
6. Fase 2 (multi-tenant) segue não iniciada — `multi-tenant-migration-agent` está pronto mas dormente, só ativa com pedido explícito do usuário.
